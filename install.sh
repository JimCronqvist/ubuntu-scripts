...
EOF"
        ...
        "10") # Install PHP 7 and Composer
            ...
            sudo apt-get install php7.0 php7.0-ldap php7.0-curl php7.0-xsl php7.0-gd php7.0-json php7.0-intl php7.0-mcrypt php7.0-mbstring php7.0-zip php7.0-soap -y
            sudo apt-get install mysql-client -y
